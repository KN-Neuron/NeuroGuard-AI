...
# Add the project root to the path to import eeg_lib modules
...
Examples:
  # Train an EEG model
  python -m eeg_lib train --model eegnet --batch_size 32 --lr 0.001 --num_epochs 10
  
  # Visualize embeddings with t-SNE
  python -m eeg_lib visualize --model_path ./models/eegnet.pth --method tsne --data_path ./data/
  
  # Evaluate a trained model
  python -m eeg_lib evaluate --model_path ./models/eegnet.pth --test_data ./data/test/
        """
    )
